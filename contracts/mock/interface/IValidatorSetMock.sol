...
interface IValidatorSetMock {
  ...
  function updateValidatorSetOld(address[] calldata operateAddrList, address[] calldata consensusAddrList, address payable[] calldata feeAddrList, uint256[] calldata commissionThousandthsList) external;
