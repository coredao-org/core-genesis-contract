...
contract CandidateHubTest is BaseTest  {
	...
	function setUp() public override {
	    BaseTest.setUp();
        s_candidateHub = CandidateHub(s_addresses.candidateHub);
	}
    ...
    function testFuzz_jailValidator(uint32 commissionThousandths, uint value, uint256 round, uint256 fine) public {
        ...
        _hoaxWithGas(s_addresses.validatorSet); // only validator may call jailValidator()
    ...
    //     vm.deal(s_addresses.validatorSet, validatorSetBalance);
