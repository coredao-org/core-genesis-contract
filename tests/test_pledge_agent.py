...
def test_move_data_with_expired_btc(pledge_agent, core_agent, btc_agent, btc_stake, candidate_hub,
                                    set_candidate):
    operators, consensuses = set_candidate
    tx_id0 = "88c233d8d6980d2c486a055c804544faa8de93eadc4a00d5bd075d19f3190b4d"
    tx_id1 = "88c233d8d6980d2c486a055c804544faa8de93eadc4a00d5bd075d19f3190b4e"
    btc_value = 1000
    script = "0x1234"
    fee = 0
    set_round_tag(LOCK_TIME // Utils.ROUND_INTERVAL - 3)
...
def __move_btc_data(tx_ids):
    return BTC_STAKE.moveData(tx_ids)
...
def __check_btc_tx_map_info(tx_id, result: dict):
    ...
    print('__check_btc_tx_map_info>>>', data)
    for i in result:
...
def __get_candidate_map_info(candidate):
    ...
    print(f'__get_candidate_map_info>>>>>>{candidate}:', candidate_info)
...
def __check_btc_receipt_map(tx_id, result: dict):
    ...
    print('__check_btc_receipt_map>>>>', receipt)
    for i in result:
