...
class TestInitHardForkDelegate:
    ...
    def test_claim_rewards_after_becoming_validator_post_upgrade(self, pledge_agent, validator_set, slash_indicator,
    ...
    def test_btclst_claim_extra_rewards_after_upgrade(self, set_candidate):
        btc_lst_value = 1000
        delegate_amount = 600000
        power_value = 1
        operators, consensuses = set_candidate
    ...
    def test_btc_data_migration_not_affected_by_stake_duration(self, set_candidate):
